...
from Mlflow_Ineuron_Project.entity.config_entity import DataIngestionConfig,Data_preprocessing_ValidationConfig,DataTransformationConfig,ModelTrainerConfig,ModelEvaluationConfig
class ConfigurationManager:
    ...
    def get_model_evaluation_config(self) -> ModelEvaluationConfig:
        ...
        model_evaluation_config = ModelEvaluationConfig(
            ...
            target_column = schema.name,
            mlflow_uri="https://dagshub.com/ShreyasDominator/Mlops_Ineuron_mlflow_census_calssification.mlflow",
